...
'use strict';
var activeScreenshot, features, featuresSlider, screenshots, screenshotsSlider, testimonials, testimonialsSlider;
...
$('.screenshot:nth-child(' + activeScreenshot + ')').addClass('active');
...
screenshotsSlider = function() {
  ...
  screenshots.on('scrollEnd', function() {
    activeScreenshot = screenshots.currentPage.pageX + 1;
